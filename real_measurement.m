...
for j=1:Ntracks
    for k=1:Nradar
        ...
        target(j).measure(ind,8) =(unitsratio('m','feet')*100)*...
            round((target(j).measure(ind,5) + erraAlt)/(unitsratio('m','feet')*100));  %Añadimos la cuantificación de 100 pies en altura
        if(k==1)
        ...
        %Calculo de la matriz de covarianza en coordenadas estereográficas
        ...
        %con adición de ruido según lo indicado en la estructura del radar
